...
#define LV_USE_ASSERT_STYLE         DEBUG /*Check if the styles are properly initialized. (Very fast, recommended)*/
#define LV_USE_ASSERT_MEM_INTEGRITY DEBUG /*Check the integrity of `lv_mem` after critical operations. (Slow)*/
